...
df <- suppressMessages(read_csv("https://raw.githubusercontent.com/aarora79/dns2vec/master/data/1.0.0.0/run_150_epochs/fqdn_tfidf_subset.csv"))
kable(df %>% tail (10),
...
Table 2 shows similar domains determined using Dns2Vec for a sample of input domains, a complete listing is available ([here](https://raw.githubusercontent.com/aarora79/dns2vec/master/data/1.0.0.0/run_150_epochs/similiar_domains_from_nb.csv "here")):
...
We also experimented with building Word2Vec style DNS analogies, see Table 3 and Figure 4. 

```{r echo=F, out.width="4in", fig.cap="Dns2Vec analogies"}
...
2. tf-idf table: https://raw.githubusercontent.com/aarora79/dns2vec/master/data/1.0.0.0/run_150_epochs/fqdn_tfidf_subset.csv
3. Similar domains: https://raw.githubusercontent.com/aarora79/dns2vec/master/data/1.0.0.0/run_150_epochs/similiar_domains_from_nb.csv
4. t-SNE: https://raw.githubusercontent.com/aarora79/dns2vec/master/data/1.0.0.0/run_150_epochs/tsne.png
5. Network topology: https://raw.githubusercontent.com/aarora79/dns2vec/master/data/1.0.0.0/run_150_epochs/network_topology.png
